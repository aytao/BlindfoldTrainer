...
public class Cube {
    ...
    // Makes a new Cube with the same sticker positions as the provided Cube. Does not copy move recording information
    public Cube(Cube cube) {
        stickers = cube.getStickers();
    }

    /*
     * Returns true if and only if the provided object is a Cube and every sticker in the provided object
     * is the same as the corresponding sticker in this Cube. Does not account for orientation; two cubes
    ...
    /*
     * If a command line integer is provided, executes the provided number of random moves,
     * and prints the moves and the resulting state of the cube to stdout. Otherwise, reads a
