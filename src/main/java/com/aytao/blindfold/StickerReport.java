...
public class StickerReport {
     ...
     * and uses the information to return a 2d mapping of sticker names to coordinates
     */
    ...
    /*
     * Given a Cube object cube, returns a char[] that represents the current state of
     * each edge-piece sticker on the cube. The array is indexed with 'a' at position 0,
    ...
    /*
     * Given a Cube object cube, returns a char[] that represents the current state of
     * each corner-piece sticker on the cube. The array is indexed with 'a' at position 0,
     * and the characters in the array represent the current sticker that is in that
     * position.
     */
